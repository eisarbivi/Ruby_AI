...
def cnData():
    global file_path, cn, source_file_path
    with open(source_file_path, "a") as file:
        file.write(cn + " --> " + file_path + "\n")
...
if __name__ == "__main__":
    ...
    print(
        "\nCollection Name is where your file stored in Ruby's database, each file must use different Collection Name (WARNING: don't use spaces)\nTo view Collection Names history, type \"history\"\n"
    )
    collectionName()
    cnData()
